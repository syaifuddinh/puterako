			...
			<div class="tab-content">
				<div id="menuFormfs" class="tab-pane fade in active">
                  ...
                  <div align="center" class="form-group">
                     <button class="btn btn-success" type="submit" name="simpan"><i class="fa fa-pencil"></i> Posting&nbsp;</button>
                     <a href="<?=base_url()?>?page=lod" class="btn btn-danger"><i class=" fa fa-reply"></i> Batal</a>
                 </div>
