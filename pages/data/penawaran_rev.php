                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody id="show-item-infrastructure">
                      ...
                      <?php
                        ...
                        ?>
                      <tr>
                        <td colspan="7" style="text-align:right"> <b> Total Nett Rp 
                          </b>
                        </td>
                        <td style="text-align:right"><b><?php echo number_format($grandtotal, 0, ",", ".") ?></b> <input type="hidden" value="<?=$grandtotal?>" id="b_grand_total"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody id="show-item-material">
                      ...
                      <?php
                        ...
                        ?>
                      <tr>
                        <td colspan="6" style="text-align:right"> <b> Total Nett Rp 
                          </b>
                        </td>
                        <td style="text-align:right"><b><?php echo number_format($grandtotal2, 0, ",", ".") ?></b> <input type="hidden" value="<?=$grandtotal2?>" id="b_grand_total"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody id="show-item-jasa">
                      ...
                      <?php
                        ...
                        ?>
                      <tr>
                        <td colspan="5" style="text-align:right"> <b> Total Nett Rp 
                          </b>
                        </td>
                        <td style="text-align:right"><b><?php echo number_format($grandtotal3, 0, ",", ".") ?></b> <input type="hidden" value="<?=$grandtotal3?>" id="b_grand_total"></td>
                      </tr>
                    </tbody>
                    ...
                    <tr>
                      ...
                      <td colspan="6">
                        <select id="diskon_utama" name="diskon_utama"  class="form-control">
...
<script>
  ...
  e.preventDefault();
    ...
    $(".animated").show();
    $.ajax({
      url: "<?=base_url()?>ajax/r_penawaran.php?func=edit",
      type: "POST",
