...
if(isset($_GET['action']) and $_GET['action'] == "edit") {
	...
	if(mysql_num_rows($result3) > 0) {
		while($res3 = mysql_fetch_array($result3)) {
			$array[$res3['id_penawaran_dtl']] = array('id' => $res3['id_penawaran_dtl'], 'description' => $res3['description_item'], 'jumlah' => $res3['qty'], 'satuan' => $res3['satuan'], 'harga' => $res3['harga'],'profit' => $res3['profit'], 'diskon' => $res3['diskon'],'note' => $res3['note'],'id_form' => $res3['id_form'], 'id_diskon' => $res3['id_diskon'],'id_profit' => $res3['id_profit']);
		}	
