  ...
  <div class="row">
    <div class="tab-content">
      <div id="menuFormfs" class="tab-pane fade in active">
        ...
        <button type="submit" id="submit" name="submit" class="btn btn-primary" tabindex="10"><i class="fa fa-check-square-o"></i> Simpan</button> 
              ...
              <tbody>
                <?php
                  ...
                  while($data = mysql_fetch_array($q_fjasa)) { 
                  	$kd_jasa = $data['kd_jasa'];
                  	$kd_jasa .= $data['ref'] > 0 ? '_REF_' . $data['ref'] : '';
                  ?>
                <tr>
                  <td> <?php echo $n++ ?></td>
                  <td><a href="<?=base_url()?>?page=form_jasa_track&action=track&kode=<?=$data['id_fjasa_hdr']?>"> <?php echo $kd_jasa;?></a></td>
